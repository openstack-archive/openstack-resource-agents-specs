...
* If your specification proposes any changes to the Openstack-Resource-Agents REST API such
...
proposed change fit in openstack-resource-agents, you can stop here and post this for review to get
...
Example JSON schema definitions can be found in the Openstack-Resource-Agents tree
http://git.openstack.org/cgit/openstack/openstack-resource-agents/tree/openstack-resource-agents/api/openstack/compute/schemas
